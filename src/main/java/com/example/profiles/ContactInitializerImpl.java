    ...
    public Map<String, User> initContacts() {
        ...
        try {
            ...
            reader.lines().forEach(c -> {
                ...
                contacts.putAll(createContact.addContactToMap(
                        createContact.getFullName(),
                        createContact.getPhoneNumber(),
            ...
            System.out.println("Включена конфигурация: init" +
                    ...
                    "\nИз файла добавлен список контактов: ");
            createContact.allContacts();
        } catch (IOException e) {
            e.printStackTrace();
        }
        return contacts;
